...
select top 1 'declare @tableID int, @datatypeID int, @editableTypeID int, @filterTypeID int; set @tableID = null; ' + CHAR(13)+CHAR(10)
		...
		+ 'begin try' + CHAR(13)+CHAR(10)
			+ 'if @tableID > 0 begin ' + CHAR(13)+CHAR(10) 
				+ (case @overwrite when 1 then
					...
					+ 'print N''Таблица ' + @code + ' обновлена'''	+ CHAR(13)+CHAR(10)
				else 'print N''Таблица ' + @code + ' существует и не будет перезаписана'''	+ CHAR(13)+CHAR(10) end)
			+ 'end; else begin' + CHAR(13)+CHAR(10) 
				...
				+ 'print N''Таблица ' + @code + ' добавлена''' + CHAR(13)+CHAR(10)
			+ 'end;' + CHAR(13)+CHAR(10)
		+ 'end try' + CHAR(13)+CHAR(10)
		+ 'begin catch' + CHAR(13)+CHAR(10)
			+ 'print N''При обновлении\добавлении таблицы ' + @code + ' возникла ошибка: '' + error_message()'	+ CHAR(13)+CHAR(10)
		+ 'end catch' + CHAR(13)+ CHAR(13)+CHAR(10)
		+ (case @overwrite when 1 then
			+ 'begin try' + CHAR(13)+CHAR(10)
				+ 'delete from as_crud_cols where as_crud_cols.tableID = @tableID;' + CHAR(13)+CHAR(10)
				+ 'print N''Колонки таблицы ' + @code + ' удалены'''	+ CHAR(13)+CHAR(10)
			+ 'end try' + CHAR(13)+CHAR(10)
			+ 'begin catch' + CHAR(13)+CHAR(10)	
				+ 'print N''При удалении колонок таблицы ' + @code + ' возникла ошибка: '' + error_message()'	+ CHAR(13)+CHAR(10)
			+ 'end catch' + CHAR(13)+ CHAR(13)+CHAR(10)
		...
		+ (select 'begin try' + CHAR(13)+CHAR(10)
			...
			+ ' insert into as_crud_cols ([tableID],[title],[tooltip],[ord],[datatypeID],[isSort],[isVisible]' + CHAR(13)
				...
				, 1, 2, '')
			 + ');' + CHAR(13)+CHAR(10)
			 + 'print N''Колонка ' + c.code + ' таблицы добавлена''' + CHAR(13)+CHAR(10)
			 + (case @overwrite when 0 then
				+ 'end' + CHAR(13)+CHAR(10) 
				+ 'else ' + CHAR(13)+CHAR(10) 
				+ 'print N''Колонка ' + c.code + ' таблицы уже существует и не будет перезаписана''' + CHAR(13)+CHAR(10)
				else '' end)
		+ 'end try' + CHAR(13)+CHAR(10)
		+ 'begin catch' + CHAR(13)+CHAR(10)
